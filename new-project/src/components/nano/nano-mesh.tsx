...
export function NanoMesh() {
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-cyan/20 bg-[#05020e]">
      <canvas ref={ref} className="block min-h-[340px] w-full" aria-hidden="true" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#05020e] via-[#05020e]/70 to-transparent p-6">
        <p className="font-serif text-xl text-white">Every interaction creates another opportunity.</p>
