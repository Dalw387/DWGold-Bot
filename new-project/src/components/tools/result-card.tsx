    ...
    <article className="paper-card flex h-full flex-col rounded-2xl border border-stone-200 p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex rounded-lg border border-stone-200 p-0.5 text-xs font-semibold">
          <button
            type="button"
            className={`rounded-md px-2 py-1 ${mode === "edit" ? "bg-[#191919] text-[#f4f3ef]" : "text-stone-600"}`}
          ...
          <button
            type="button"
            className={`rounded-md px-2 py-1 ${mode === "preview" ? "bg-[#191919] text-[#f4f3ef]" : "text-stone-600"}`}
      ...
      {mode === "edit" ? (
        <>
          ...
          <textarea
            ...
            rows={12}
            className="mt-4 w-full flex-1 resize-y rounded-xl border border-stone-300 bg-white px-3.5 py-3 text-sm leading-6 text-stone-800 outline-none focus:border-[#1e3a34] focus:ring-2 focus:ring-[rgba(30,58,52,0.25)]"
          />
        ...
        <div className="mt-4 flex-1 rounded-2xl border border-stone-200 bg-white p-4">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-sm bg-[#191919] text-xs font-semibold text-[#f4f3ef]">
              {initials || "LL"}
            </span>
            <div>
