...
export function OneJobCover() {
  ...
  return (
    <section id="value" aria-labelledby="value-heading" className="border-b border-border py-16 sm:py-24">
      <Container className="max-w-3xl">
        ...
        <label className="mt-10 block text-sm font-medium text-foreground">
          ...
          <input
            ...
            placeholder="e.g. 250"
            className="mt-2 w-full max-w-xs border border-ink bg-transparent px-3 py-2.5 text-base text-foreground outline-none focus:ring-2 focus:ring-ink"
          />
        </label>
        <p className="mt-6 min-h-[3.5rem] text-lg leading-8 text-foreground" role="status">
          {result ?? `Pay ${HOUSE_PRICE_SHORT} once. Keep using the desk. One extra customer is the point.`}
        </p>
        <ul className="mt-12 grid gap-8 border-t border-border pt-12 sm:grid-cols-3">
