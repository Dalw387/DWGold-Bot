  ...
  return (
    <div className="mesh border-b border-stone-200">
      <Container className="py-14 sm:py-20">
        ...
        <h1 className="font-display mt-3 max-w-3xl text-4xl font-semibold tracking-tight text-stone-900 sm:text-5xl">
                  ...
                  {tools.map((tool) => (
                    <li key={tool.slug}>
                      <Link
                        ...
                        className="paper-card flex h-full flex-col rounded-3xl border border-stone-200 p-6 transition hover:-translate-y-0.5 hover:border-indigo-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
