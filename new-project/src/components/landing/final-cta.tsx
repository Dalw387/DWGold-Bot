  ...
  return (
    <section className="ink-hero py-20 sm:py-24">
      <Container className="text-center">
        ...
        <h2 className="font-display mt-4 text-3xl font-medium tracking-tight text-[#f4f3ef] sm:text-5xl">
          Try it free. Pay {HOUSE_PRICE_SHORT} only if you want the desk.
        </h2>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#cfcbc3]">
